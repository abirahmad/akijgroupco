...
const ListCard = ({ jobTitle, jobDescription, onViewClick }) => {
  return (
    <div className="bg-white shadow-lg rounded-xl p-6 mb-6 flex justify-between items-center transform transition duration-300 hover:scale-105">
      ...
      <button
        onClick={onViewClick}
        className="ml-4 px-5 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg shadow-md hover:from-blue-600 hover:to-indigo-600 transition duration-300 transform hover:scale-110"
      >
        Details
      </button>
    </div>
